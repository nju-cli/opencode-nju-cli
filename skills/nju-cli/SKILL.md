---
name: nju-cli
description: 南京大学相关操作，比如教务通知、研究生培养与学位、交换生、排名、团委等等。
---
...
| ehall网上办事大厅：包含本科培养方案、研究生培养方案、课表、成绩查询等                                                                                                                                                                 | subcommands/ehall.md            |
...
| 研究生院：通知公告、办事指南、机构简介与各办公室、培养工作、国际交流、培养项目、学位与导师、学籍学历及奖助政策等栏目；支持列表翻页、正文和静态页面读取                                                        | subcommands/graduate-school.md    |
